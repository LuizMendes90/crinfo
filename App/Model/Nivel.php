...
class Nivel extends Model
{
    ...
    public function create()
    {
        ...
        $this->validator->set('Nivel', $this->nivel)->is_required();
        ...
        if (!$validate) {
         ...
         $sql = "INSERT INTO `" . $this->table . "` (nivel,descricao,status) 
                                                VALUES 
                                                (:nivel,:descricao,:status)";

        $query = $this->dbh->prepare($sql);

        $query->bindValue(':nivel', $this->nivel, PDO::PARAM_STR);
