...
interact_fields['id'] = '';
interact_fields['id_menu'] = '';
interact_fields['subMenu'] = '';
interact_fields['nomeArquivo'] = '';
        ...
        success: function (data) {
            ...
            if (data.count) {
                ...
                $.each(data.result, function (key, value) {
                    option += '<option value="' + value.id + '" >' + value.menu + '</option>';
                });
            ...
            if (data.count) {
                ...
                $.each(data.result, function (key, value) {
                    ...
                    tbody += '<tr>' +
                        ...
                        '<td class="delete" data-id="' + value.id + '"></td>' +
                        '</tr>';
                });
...
function create(formData) {
    ...
    formData.append('action', "SubMenu");
