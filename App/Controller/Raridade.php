...
require_once MODEL . DS . 'Raridade.php';
require_once VIEW . DS . 'Raridade.php';

use App\Core\Controller;
use App\Core\Model;
use App\Model\Raridade as Carta_Model;
use App\View\Raridade as Carta_View;

class Raridade extends Controller
{
