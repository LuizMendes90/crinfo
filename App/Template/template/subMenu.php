            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal form-label-left input_mask" id="form-principal" method='POST'
                    ...
                    <div class="form-group col-md-6">
                        <label>Menu:</label>
                        <select class="select2_single form-control" id="id_menu">
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="subMenu"
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="nomeArquivo"
